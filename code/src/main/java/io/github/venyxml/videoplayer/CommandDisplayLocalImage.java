...
public class CommandDisplayLocalImage implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        long convToArrStartTime,convToArrEndTime, placeStartTime, placeEndTime;

        try {
            File ref = new File(args[6]);
